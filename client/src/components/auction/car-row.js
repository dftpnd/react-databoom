	...
	render() {
		...
		return (
			<div className="car-row">
				...
				<button className="car-row__make-bid common-button" onClick={this.openModal} type="button">Сделать
					ставку
				</button>
				<Modal
					...
					<p>
						...
						<input type="text" value={this.state.newBidValue}
							   onChange={this.handleBidChange}/>
					</p>
					<button type="button" className="common-button" onClick={this.makeBid}>
